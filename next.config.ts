...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "style-src 'self' 'unsafe-inline' https://static.tawk.to",
      ...
      "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://*.clarity.ms https://embed.tawk.to wss://embed.tawk.to https://va.tawk.to wss://va.tawk.to",

...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://*.clarity.ms https://embed.tawk.to https://va.tawk.to https://static.tawk.to https://vercel.live https://connect.facebook.net",
      "style-src 'self' 'unsafe-inline' https://*.clarity.ms https://embed.tawk.to https://static.tawk.to",
      "img-src 'self' data: blob: https://www.google-analytics.com https://www.googletagmanager.com https://*.clarity.ms https://*.tawk.to https://www.facebook.com",
      "font-src 'self' https://embed.tawk.to https://static.tawk.to",
      "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://*.clarity.ms https://embed.tawk.to wss://embed.tawk.to https://*.tawk.to wss://*.tawk.to https://www.facebook.com https://connect.facebook.net",

...
export const HERO = {
  subtitle:
    "Tell OpenLegion \"I want a marketing agency,\" \"I want a sales team,\" or \"I want a research desk,\" and it deploys the agent stack with budgets, permissions, and secure credential controls built in.",

...
ADK 免费（Apache 2.0）。Vertex AI Agent Engine Runtime 费用为 $0.0864/vCPU 小时加上每 1,000 事件 $0.25。OpenLegion 源码可用（PolyForm Perimeter License 1.0.1），采用自带 API 密钥模式，零加价。

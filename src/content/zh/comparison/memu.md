...
**AGPL-3.0 许可证。** 服务端许可证为 AGPL-3.0，要求分发任何修改版本的源代码，以及通过网络与 MemU 交互的任何软件（取决于解释）。许多企业避免 AGPL。这是比 OpenLegion 的 BSL 1.1 或多数竞品的 MIT/Apache 显著更严苛的许可证。

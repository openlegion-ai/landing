...
Strands 免费（Apache 2.0）。AWS 服务成本另算：Bedrock 按 token 计费、AgentCore Runtime 计算、Lambda/Fargate/EC2 基础设施。OpenLegion 源码可用（PolyForm Perimeter License 1.0.1），采用自带 API 密钥模式，零加价。

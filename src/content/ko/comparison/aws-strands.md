...
Strands는 무료입니다(Apache 2.0). AWS 서비스 비용이 적용됩니다: Bedrock 토큰당 가격, AgentCore Runtime 컴퓨팅, Lambda/Fargate/EC2 인프라. OpenLegion은 BYO API 키 모델과 마크업 없음의 소스 공개(PolyForm Perimeter License 1.0.1)입니다.

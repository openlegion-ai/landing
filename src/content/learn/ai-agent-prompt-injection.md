...
OWASP's LLM Top 10 v1.1 provides a starter set; the greshake/llm-security repository (2,098 stars, MIT) contains research-grade indirect injection examples from the foundational Greshake et al. (2023) paper. Static libraries are fast and cheap but only catch known patterns.

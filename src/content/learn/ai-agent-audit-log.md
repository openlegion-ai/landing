...
description: "Build an immutable AI agent audit log for SOC 2, GDPR Article 30, and OWASP LLM08. Covers append-only design, OTLP schema, SIEM integration, tamper-evidence, and forensic investigation."
...
## Compliance Requirements: SOC 2, GDPR, and OWASP LLM08
...
### OWASP LLM08:2025 — Mandatory Immutable Audit Trail

OWASP LLM08:2025 (Unbounded Agent Actions) lists an immutable audit trail as one of four mandatory mitigations for autonomous agents:
...
OpenTelemetry OTLP Log spec v1.0 (May 2024) provides the standardized structure for agent audit records. Using OTLP enables SIEM integration without custom parsers and distributed trace correlation via TraceId and SpanId.
...
**What credentials were used?** The `credential_handles_used` field. If a handle appears in an unexpected context — the researcher agent using the publisher's GitHub token — this is the forensic finding.

...
Strands ฟรี (Apache 2.0) ค่าบริการ AWS ใช้: ราคา Bedrock ต่อ token, compute AgentCore Runtime, โครงสร้างพื้นฐาน Lambda/Fargate/EC2 OpenLegion เปิดเผยซอร์สโค้ด (PolyForm Perimeter License 1.0.1) พร้อมโมเดล bring-your-own-API-keys และไม่บวกราคา

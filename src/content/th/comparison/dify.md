...
- **ความแตกต่างของใบอนุญาต**: Dify ใช้ Apache 2.0 ดัดแปลง (ห้าม multi-tenant SaaS โดยไม่มีข้อตกลงเป็นลายลักษณ์อักษร) OpenLegion ใช้ BSL 1.1
...
| **ใบอนุญาต** | BSL 1.1 | Apache 2.0 ดัดแปลง |

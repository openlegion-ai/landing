...
Strandsは無料（Apache 2.0）です。AWSサービスコストが適用されます：Bedrockのトークン単価、AgentCore Runtimeコンピュート、Lambda/Fargate/EC2インフラ。OpenLegionはソース公開（PolyForm Perimeter License 1.0.1）で、BYO APIキーモデルとマークアップなし。

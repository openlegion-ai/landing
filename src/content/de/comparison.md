...
| **OpenLegion** | neu | BSL 1.1 | Docker pro Agent (Standard und einziger Modus) | Vault-Proxy (Agenten sehen keine Keys) | Pro Agent tägliche/monatliche Hartabschaltung | Keine bekannt (v0.1.0) | Aktiv |

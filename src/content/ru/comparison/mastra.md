...
| **Лицензия** | Apache 2.0 + пропр. ee/ | BSL 1.1 → Apache 2.0 (4 года) |
...
### Mastra — open-source?
Ядро (packages/) под Apache 2.0. Компоненты enterprise/ — проприетарные. RBAC, аутентификация, большинство инструментов хранения — за дополнительную плату. OpenLegion сейчас BSL 1.1 с переходом в Apache 2.0 через 4 года.

...
OpenLegion source-available под лицензией PolyForm Perimeter License 1.0.1 и доступен на [GitHub](https://github.com/openlegion-ai/openlegion). Проект также предлагает hosted-платформу для команд, которые хотят managed-инфраструктуру без self-hosting.

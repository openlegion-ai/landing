...
- **License अंतर**: Dify modified Apache 2.0 का उपयोग करता है (written agreement के बिना कोई multi-tenant SaaS नहीं)। OpenLegion PolyForm Perimeter License 1.0.1 का उपयोग करता है।

...
- वही engine PolyForm Perimeter License 1.0.1 के तहत source-available है, इसलिए आप managed शुरू कर सकते हैं और बाद में बिना rewrite के self-hosted पर जा सकते हैं।
...
| विचार | Self-hosted (PolyForm Perimeter License 1.0.1) | Managed hosting |
|---|---|---|

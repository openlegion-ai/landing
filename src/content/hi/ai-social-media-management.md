...
- **Self-hosted या managed।** BSL 1.1 के तहत source-available — regulated-industry compliance के लिए अपने स्वयं के infra पर चलाएँ, या समान isolation guarantees के साथ hosted plane का उपयोग करें।
...
| **Self-hostable** | नहीं | नहीं | हाँ, BSL 1.1 के तहत source-available |
